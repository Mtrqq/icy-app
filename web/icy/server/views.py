...
def index():
    models_list = classifier.list_available_models()
...
def classify_image():
    ...
    task_args = {"image_url": image_url, "model_name": selected_model, "stringify_labels": True}
    task_id = tasks.submit_task(classifier.recognize_image, **task_args)
    response_json = {"Status": "Success", "Data": {"TaskID": task_id}}
